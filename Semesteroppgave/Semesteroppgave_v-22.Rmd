...
```
## **Introduction**
It is important to create reports so that they can be easily updated with new data when they are available. It is also an advantage if you can exchange data on the same topic, for example new time periods.  
